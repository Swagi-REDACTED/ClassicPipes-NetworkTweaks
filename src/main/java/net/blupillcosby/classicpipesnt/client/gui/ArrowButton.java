package net.blupillcosby.classicpipesnt.client.gui;
...
public class ArrowButton extends AbstractButton {
    ...
    private static final Identifier ARROW_LEFT = Identifier.fromNamespaceAndPath("easy_villagers", "textures/gui/arrow_left.png");
    private static final Identifier ARROW_RIGHT = Identifier.fromNamespaceAndPath("easy_villagers", "textures/gui/arrow_right.png");
